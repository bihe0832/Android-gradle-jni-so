...
cp -r $localPath/MD5/app/build/intermediates/binaries/release/all/lib/* $localPath/GradleTest/gradletestlibrary/src/main/jniLibs/
checkResult
cp -r $localPath/MD5/app/build/intermediates/binaries/release/all/lib/* $localPath/bin/MD5/
checkResult
